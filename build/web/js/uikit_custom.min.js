...
function(t) {
    ...
    if (n.version = "2.21.0", n.noConflict = function() {
        return o && (t.UIkit = o, e.UIkit = o, e.fn.uk = o.fn), n
    }, n.prefix = function(t) {
        return t
    }, n.$ = e, n.$doc = n.$(document), n.$win = n.$(window), n.$html = n.$("html"), n.support = {}, n.support.transition = function() {
        var t = function() {
        ...
        return i = e.extend({
            topoffset: 0,
            leftoffset: 0
        }, i), u + o.height() >= a && u - i.topoffset <= a + n.$win.height() && l + o.width() >= s && l - i.leftoffset <= s + n.$win.width() ? !0 : !1
        ...
        return s = new Function("$data", ["var __ret = [];", "try {", "with($data){", u ? '__ret = ["Not all blocks are closed correctly."]' : l.join(""), "};", "}catch(e){__ret = [e.message];}", 'return __ret.join("").replace(/\\n\\n/g, "\\n");', "function escape(html) { return String(html).replace(/&/g, '&amp;').replace(/\"/g, '&quot;').replace(/</g, '&lt;').replace(/>/g, '&gt;');}"].join("\n")), e ? s(e) : s
    }, n.Utils.events = {}, n.Utils.events.click = n.support.touch ? "tap" : "click", t.UIkit = n, n.fn = function(t, i) {
        var o = arguments,
            s = t.match(/^([a-z\-]+)(?:\.([a-z]+))?/i),
            a = s[1],
            r = s[2];
    ...
    }, e.UIkit = n, e.fn.uk = n.fn, n.langdirection = "rtl" == n.$html.attr("dir") ? "right" : "left", n.components = {}, n.component = function(t, i) {
        var o = function(i, s) {
                var a = this;
        ...
        n.support.mutationobserver && (e = e ||
        ...
        t = t || document, n.domObservers.forEach(function(e) {
            e(t)
        })
    ...
    function o() {
        a && clearTimeout(a), r && clearTimeout(r), l && clearTimeout(l), u && clearTimeout(u), a = r = l = u = null, c = {}
    }
    function s(t) {
    ...
    if (!t.fn.swipeLeft) {
        ...
        t(function() {
            ...
            "MSGesture" in window && (d = new MSGesture, d.target = document.body), t(document).on("MSGestureEnd gestureend", function(t) {
                ...
                e && (c.el.trigger("swipe"), c.el.trigger("swipe" + e))
            }).on("touchstart MSPointerDown pointerdown", function(e) {
                ("MSPointerDown" != e.type || s(e.originalEvent)) && (m = "MSPointerDown" == e.type || "pointerdown" == e.type ? e : e.originalEvent.touches[0], p = Date.now(), f = p - (c.last || p), c.el = t("tagName" in m.target ? m.target : m.target.parentNode), a && clearTimeout(a), c.x1 = m.pageX, c.y1 = m.pageY, f > 0 && 250 >= f && (c.isDoubleTap = !0), c.last = p, u = setTimeout(i, h), !d || "MSPointerDown" != e.type && "pointerdown" != e.type && "touchstart" != e.type || d.addPointer(e.originalEvent.pointerId))
            }).on("touchmove MSPointerMove pointermove", function(t) {
                ("MSPointerMove" != t.type || s(t.originalEvent)) && (m = "MSPointerMove" == t.type || "pointermove" == t.type ? t : t.originalEvent.touches[0], n(), c.x2 = m.pageX, c.y2 = m.pageY, g += Math.abs(c.x1 - c.x2), v += Math.abs(c.y1 - c.y2))
            }).on("touchend MSPointerUp pointerup", function(i) {
                ("MSPointerUp" != i.type || s(i.originalEvent)) && (n(), c.x2 && Math.abs(c.x1 - c.x2) > 30 || c.y2 && Math.abs(c.y1 - c.y2) > 30 ? l = setTimeout(function() {
                    c.el.trigger("swipe"), c.el.trigger("swipe" + e(c.x1, c.x2, c.y1, c.y2)), c = {}
                }, 0) : "last" in c && (isNaN(g) || 30 > g && 30 > v ? r = setTimeout(function() {
                    var e = t.Event("tap");
                    e.cancelTouch = o, c.el.trigger(e), c.isDoubleTap ? (c.el.trigger("doubleTap"), c = {}) : a = setTimeout(function() {
        ...
        var n = function(e) {
                if (!(e.length < 2)) {
                    ...
                    e.each(function() {
                        ...
                        var e = t.$(this),
                            n = i - ("border-box" == e.css("box-sizing") ? 0 : e.outerHeight() - e.height());
    ...
    t.component("smoothScroll", {
        ...
        init: function() {
            ...
            this.on("click", function(n) {
                n.preventDefault(), e(t.$(t.$(this.hash).length ? this.hash : "body"), i.options)
            })
        }
                ...
                s = function() {
                    ...
                    n.each(function(n) {
                        var r = t.$(this),
                            ...
                            u = t.Utils.isInView(r, i.options),
                            d = r.data("ukScrollspyCls") || o[a].trim();
                        !u || l || r.data("scrollspy-idle") || (e || (r.addClass(i.options.initcls), i.offset = r.offset(), e = !0, r.trigger("init.uk.scrollspy")), r.data("scrollspy-idle", setTimeout(function() {
                        ...
                        }, i.options.delay * s)), s++), !u && l && i.options.repeat && (r.data("scrollspy-idle") && clearTimeout(r.data("scrollspy-idle")), r.removeClass("uk-scrollspy-inview").toggleClass(d), r.data("inviewstate", !1), r.trigger("outview.uk.scrollspy")), a = o[a + 1] ? a + 1 : 0
                    })
                };
    ...
    t.component("scrollspynav", {
        ...
        init: function() {
            var i, n = [],
                ...
                d = function() {
                    i = [];
                    for (var n = 0; n < a.length; n++) t.Utils.isInView(a.eq(n), u.options) && i.push(a.eq(n));
                    if (i.length) {
                        var s, d = e.scrollTop(),
                            c = function() {
                                for (var t = 0; t < i.length; t++) if (i[t].offset().top >= d) return i[t]
                            }();
                        if (!c) return;
                        u.options.closest ? (o.closest(l).removeClass(r), s = o.filter("a[href='#" + c.attr("id") + "']").closest(l).addClass(r)) : s = o.removeClass(r).filter("a[href='#" + c.attr("id") + "']").addClass(r), u.element.trigger("inview.uk.scrollspynav", [c, s])
                    }
                };
            this.options.smoothscroll && t.smoothScroll && o.each(function() {
                t.smoothScroll(this, u.options.smoothscroll)
    ...
    t.component("dropdown", {
        ...
        init: function() {
            ...
            this.dropdown = this.find(".uk-dropdown"), this.centered = this.dropdown.hasClass("uk-dropdown-center"), this.justified = this.options.justify ? t.$(this.options.justify) : !1, this.boundary = t.$(this.options.boundary), this.flipped = this.dropdown.hasClass("uk-dropdown-flip"), this.boundary.length || (this.boundary = t.$win), this.element.attr("aria-haspopup", "true"), this.element.attr("aria-expanded", this.element.hasClass("uk-open")), "click" == this.options.mode || t.support.touch ? this.on("click.uikit.dropdown", function(e) {
                var i = t.$(e.target);
                i.parents(".uk-dropdown").length || ((i.is("a[href='#']") || i.parent().is("a[href='#']") || n.dropdown.length && !n.dropdown.is(":visible")) && e.preventDefault(), i.blur()), n.element.hasClass("uk-open") ? (i.is("a:not(.js-uk-prevent)") || i.is(".uk-dropdown-close") || !n.dropdown.find(e.target).length) && n.hide() : n.show()
            }) : this.on("mouseenter", function(t) {
                n.remainIdle && clearTimeout(n.remainIdle), e && clearTimeout(e), i && i == n || (e = i && i != n ? setTimeout(function() {
                ...
                var i = t.$(e.target);
                n.remainIdle && clearTimeout(n.remainIdle), (i.is("a[href='#']") || i.parent().is("a[href='#']")) && e.preventDefault(), n.show()
            })
        },
        show: function() {
        ...
        registerOuterClick: function() {
            ...
            t.$html.off("click.outer.dropdown"), setTimeout(function() {
                t.$html.on("click.outer.dropdown", function(o) {
                    e && clearTimeout(e);
                    var s = t.$(o.target);
                    i != n || !s.is("a:not(.js-uk-prevent)") && !s.is(".uk-dropdown-close") && n.dropdown.find(o.target).length || (n.hide(), t.$html.off("click.outer.dropdown"))
                })
            }, 10)
        },
                ...
                if (this.centered && (i.css("margin-" + t.langdirection, -1 * (parseFloat(o) / 2 - i.parent().width() / 2)), n = i.offset(), (o + n.left > s || n.left < 0) && (i.css("margin-" + t.langdirection, ""), n = i.offset())), this.justified && this.justified.length) {
                    ...
                    if (i.css("min-width", r), "right" == t.langdirection) {
                        var l = s - (this.justified.offset().left + r),
                            u = s - (i.offset().left + i.outerWidth());
                        i.css("margin-right", l - u)
    ...
    function e(e, i) {
        return i ? ("object" == typeof e ? (e = e instanceof jQuery ? e : t.$(e), e.parent().length && (i.persist = e, i.persist.data("modalPersistParent", e.parent()))) : e = t.$("<div></div>").html("string" == typeof e || "number" == typeof e ? e : "UIkit.modal Error: Unsupported data type: " + typeof e), e.appendTo(i.element.find(".uk-modal-dialog")), i) : void 0
    }
    var i, n = !1,
        o = 0,
        s = t.$html;
    t.component("modal", {
        ...
        resize: function() {
            ...
            if (this.scrollbarwidth = window.innerWidth - t, i.css(this.paddingdir, this.scrollbarwidth), this.element.css("overflow-y", this.scrollbarwidth ? "scroll" : "auto"), !this.updateScrollable() && this.options.center) {
                ...
                this.dialog.css(e + n < window.innerHeight ? {
        ...
        _hide: function() {
            this.active = !1, o--, this.element.hide().removeClass("uk-open"), this.element.attr("aria-hidden", "true"), o || (s.removeClass("uk-modal-page"), i.css(this.paddingdir, "")), n === this && (n = !1), this.trigger("hide.uk.modal")
        },
        isActive: function() {
            return this.active
        }
        ...
        i = t.$.isFunction(i) ? i : function() {}, n = t.$.extend(!0, {
            bgclose: !1,
            keyboard: !1,
            modal: !1,
            labels: t.modal.labels
        }, n);
        var o = t.modal.dialog(['<div class="uk-margin uk-modal-content">' + String(e) + "</div>", '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js-modal-confirm">' + n.labels.Ok + '</button> <button class="uk-button uk-modal-close">' + n.labels.Cancel + "</button></div>"].join(""), n);
    ...
    }, t.modal.prompt = function(e, i, n, o) {
        ...
        var n = t.modal.dialog(['<div class="uk-margin uk-modal-content">' + String(e || '<div class="uk-text-center">...</div>') + "</div>"].join(""), t.$.extend({
            bgclose: !1,
            keyboard: !1,
            modal: !1
        }, i));
    ...
    t.component("nav", {
        ...
        init: function() {
            ...
            this.on("click.uikit.nav", this.options.toggle, function(i) {
                ...
                i.wrap('<div style="overflow:hidden;height:0;position:relative;"></div>'), n.data("list-container", i.parent()[o ? "removeClass" : "addClass"]("uk-hidden")), n.attr("aria-expanded", n.hasClass("uk-open")), o && e.open(n, !0)
            })
        },
        open: function(i, n) {
            var o = this,
            ...
            this.options.multiple || s.children(".uk-open").not(i).each(function() {
                ...
                height: a.hasClass("uk-open") ? e(r.find("ul:first")) : 0
            }, function() {
        ...
        n = {
            show: function(n) {
                if (n = t.$(n), n.length) {
                    ...
                    }).addClass("uk-offcanvas-page"), o.css(a ? "margin-right" : "margin-left", (a ? -1 : 1) * s.outerWidth() * l).width(), i.css("margin-top", -1 * e.y), s.addClass("uk-offcanvas-bar-show"), this._initElement(n), s.trigger("show.uk.offcanvas", [n, s]), n.attr("aria-hidden", "false")
                }
            },
            hide: function(n) {
                var o = t.$("body"),
            ...
            _initElement: function(e) {
                e.data("OffcanvasInit") || (e.on("click.uk.offcanvas swipeRight.uk.offcanvas swipeLeft.uk.offcanvas", function(e) {
                    ...
                    e.stopImmediatePropagation(), n.hide()
                    ...
                    "#" != o && (t.$doc.one("hide.uk.offcanvas", function() {
                        ...
                        e.length || (e = t.$('[name="' + o.replace("#", "") + '"]')), e.length && i.attr("data-uk-smooth-scroll") && t.Utils.scrollToElement ? t.Utils.scrollToElement(e, t.Utils.options(i.attr("data-uk-smooth-scroll") || "{}")) : window.location.href = o
                    }), n.hide())
    ...
    t.component("offcanvasTrigger", {
        ...
        init: function() {
            ...
            this.options = t.$.extend({
                ...
                t.preventDefault(), n.show(e.options.target)
            })
        }
    }), t.offcanvas = n
}(UIkit), function(t) {
    ...
    t.component("switcher", {
        ...
        "slide-vertical": function(t, i, n) {
            var o = ["uk-animation-slide-top", "uk-animation-slide-bottom"];
            return t && t.index() > i.index() && o.reverse(), e.apply(this, [o, t, i])
        },
        ...
        "slide-horizontal": function(t, i, n) {
    ...
    t.component("tab", {
        ...
        init: function() {
            ...
            this.current = !1, this.on("click.uikit.tab", this.options.target, function(i) {
                if (i.preventDefault(), !e.switcher || !e.switcher.animating) {
                    ...
                    n.removeClass("uk-active").blur(), e.trigger("change.uk.tab", [t.$(this).addClass("uk-active"), e.current]), e.current = t.$(this), e.options.connect || (n.attr("aria-expanded", "false"), t.$(this).attr("aria-expanded", "true"))
                }
                ...
                var n = t.$(this);
                e.element.children("li:not(.uk-tab-responsive)").eq(n.data("index")).trigger("click")
                ...
                mode: "click"
            }), e.trigger("change.uk.tab", [this.element.find(this.options.target).not(".uk-tab-responsive").filter(".uk-active")]), this.check(), t.$win.on("resize orientationchange", t.Utils.debounce(function() {
        ...
        check: function() {
            ...
            var i, n, o, s = e.eq(0).offset().top + Math.ceil(e.eq(0).height() / 2),
                a = !1;
            if (this.responsivetab.lst.empty(), e.each(function() {
                t.$(this).offset().top > s && (a = !0)
            }), a) for (var r = 0; r < e.length; r++) i = t.$(e.eq(r)), n = i.find("a"), "none" == i.css("float") || i.attr("uk-dropdown") || (i.hasClass("uk-disabled") || (o = i[0].outerHTML.replace("<a ", '<a data-index="' + r + '" '), this.responsivetab.lst.append(o)), i.addClass("uk-hidden"));
    ...
    return t.component("accordion", {
        ...
        toggleItem: function(i, n, o) {
            var s = this;
            i.data("toggle").toggleClass(this.options.clsactive);
            var a = i.data("toggle").hasClass(this.options.clsactive);
            o && (this.toggle.not(i.data("toggle")).removeClass(this.options.clsactive), this.content.not(i.data("content")).parent().stop().css("overflow", "hidden").animate({
                height: 0
            }, {
                easing: this.options.easing,
                duration: n ? this.options.duration : 0
            }).attr("aria-expanded", "false")), i.stop().css("overflow", "hidden"), n ? i.animate({
                height: a ? e(i.data("content")) : 0
            }, {
                easing: this.options.easing,
                duration: this.options.duration,
                complete: function() {
            ...
            }) : (i.height(a ? "auto" : 0), a && (i.css({
                overflow: ""
            }), t.Utils.checkDisplay(i.data("content"))), this.trigger("display.uk.check")), i.attr("aria-expanded", a), this.element.trigger("toggle.uk.accordion", [a, i.data("toggle"), i.data("content")])
        },
        update: function() {
            var e, i, n, o = this;
            this.toggle = this.find(this.options.toggle), this.content = this.find(this.options.containers), this.content.each(function(s) {
                e = t.$(this), e.parent().data("wrapper") ? i = e.parent() : (i = t.$(this).wrap('<div data-wrapper="true" style="overflow:hidden;height:0;position:relative;"></div>').parent(), i.attr("aria-expanded", "false")), n = o.toggle.eq(s), i.data("toggle", n), i.data("content", e), n.data("wrapper", i), e.data("wrapper", i)
        ...
        boot: function() {
            t.$html.on("focus.autocomplete.uikit", "[data-uk-autocomplete]", function(e) {
                ...
                if (!i.data("autocomplete")) {
                    t.autocomplete(i, t.Utils.options(i.attr("data-uk-autocomplete")))
                }
            ...
            if ("string" == typeof e || e.hasClass(this.options.skipClass)) {
                if ("next" == e || "prev" == e) {
                    if (this.selected) {
                        ...
                        s = o.eq("next" == e ? a + 1 < o.length ? a + 1 : 0 : 0 > a - 1 ? o.length - 1 : a - 1)
                    } else s = o["next" == e ? "first" : "last"]();
                    s = t.$(s)
                }
            } else s = e;
            if (s && s.length && (this.selected = s, o.removeClass(this.options.hoverClass), this.selected.addClass(this.options.hoverClass), i)) {
                var r = s.position().top,
                    l = n.dropdown.scrollTop(),
                    u = n.dropdown.height();
                (r > u || 0 > r) && n.dropdown.scrollTop(l + r)
            }
        },
        select: function() {
            if (this.selected) {
    ...
    return t.component("datepicker", {
        defaults: {
            ...
            template: function(e, i) {
                var n, o, s, a = "";
                if (i.maxDate !== !1 && (n = isNaN(i.maxDate) ? moment(i.maxDate, i.format) : moment().add(i.maxDate, "days")), i.minDate !== !1 && (o = isNaN(i.minDate) ? moment(i.minDate, i.format) : moment().add(i.minDate - 1, "days")), a += '<div class="uk-datepicker-nav uk-clearfix">', a += '<a href="" class="uk-datepicker-previous"></a>', a += '<a href="" class="uk-datepicker-next"></a>', t.formSelect) {
                    var r, l, u, d, c = (new Date).getFullYear(),
                        h = [];
                    for (s = 0; s < i.i18n.months.length; s++) h.push(s == e.month ? '<option value="' + s + '" selected>' + i.i18n.months[s] + "</option>" : '<option value="' + s + '">' + i.i18n.months[s] + "</option>");
                    for (r = '<span class="uk-form-select">' + i.i18n.months[e.month] + '<select class="update-picker-month">' + h.join("") + "</select></span>", h = [], u = o ? o.year() : c - 50, d = n ? n.year() : c + 20, s = u; d >= s; s++) h.push(s == e.year ? '<option value="' + s + '" selected>' + s + "</option>" : '<option value="' + s + '">' + s + "</option>");
                    l = '<span class="uk-form-select">' + e.year + '<select class="update-picker-year">' + h.join("") + "</select></span>", a += '<div class="uk-datepicker-heading">' + r + " " + l + "</div>"
                } else a += '<div class="uk-datepicker-heading">' + i.i18n.months[e.month] + " " + e.year + "</div>";
                for (a += "</div>", a += '<table class="uk-datepicker-table">', a += "<thead>", s = 0; s < e.weekdays.length; s++) e.weekdays[s] && (a += "<th>" + e.weekdays[s] + "</th>");
                for (a += "</thead>", a += "<tbody>", s = 0; s < e.days.length; s++) if (e.days[s] && e.days[s].length) {
                    a += "<tr>";
                    for (var p = 0; p < e.days[s].length; p++) if (e.days[s][p]) {
                        var f = e.days[s][p],
                            m = [];
                        f.inmonth || m.push("uk-datepicker-table-muted"), f.selected && m.push("uk-active"), n && f.day > n && m.push("uk-datepicker-date-disabled uk-datepicker-table-muted"), o && o > f.day && m.push("uk-datepicker-date-disabled uk-datepicker-table-muted"), a += '<td><a href="" class="' + m.join(" ") + '" data-date="' + f.day.format() + '">' + f.day.format("D") + "</a></td>"
                    }
                    a += "</tr>"
                }
        ...
        boot: function() {
            t.$win.on("resize orientationchange", function() {
                ...
                if (!i.data("datepicker")) {
                    e.preventDefault(); {
                        t.datepicker(i, t.Utils.options(i.attr("data-uk-datepicker")))
                    }
                    i.trigger("focus")
                }
            }), t.$html.on("click focus", "*", function(n) {
                var o = t.$(n.target);
                !i || o[0] == e[0] || o.data("datepicker") || o.parents(".uk-datepicker:first").length || i.hide()
            })
        },
        init: function() {
            if (!t.support.touch || "date" != this.element.attr("type") || this.options.mobile) {
                ...
                this.current = this.element.val() ? moment(this.element.val(), this.options.format) : moment(), this.on("click focus", function() {
                    i !== n && n.pick(this.value ? this.value : n.options.minDate ? n.options.minDate : "")
                }).on("change", function() {
                    n.element.val() && !moment(n.element.val(), n.options.format).isValid() && n.element.val(moment().format(n.options.format))
                }), e || (e = t.$('<div class="uk-dropdown uk-datepicker"></div>'), this.options.addClass && e.addClass(this.options.addClass), e.on("click", ".uk-datepicker-next, .uk-datepicker-previous, [data-date]", function(n) {
                    n.stopPropagation(), n.preventDefault();
                    var o = t.$(this);
                    return o.hasClass("uk-datepicker-date-disabled") ? !1 : void(o.is("[data-date]") ? (i.element.val(moment(o.data("date")).format(i.options.format)).trigger("change"), e.removeClass("uk-dropdown-shown"), setTimeout(function() {
                        e.removeClass("uk-dropdown-active")
                    }, 280), i = !1) : i.add(1 * (o.hasClass("uk-datepicker-next") ? 1 : -1), "months"))
        ...
        pick: function(n) {
            ...
            this.current = n ? moment(n, this.options.format) : moment(), this.initdate = this.current.format("YYYY-MM-DD"), this.update(), "right" == t.langdirection && (r.right = window.innerWidth - (r.left + this.element.outerWidth()), r.left = "");
            var l = a - this.element.outerHeight() + this.element.height() - this.options.offsettop - e.outerHeight(),
                u = a + this.element.outerHeight() + this.options.offsettop;
            r.top = u, "top" == this.options.pos ? (r.top = l, e.addClass("uk-dropdown-up")) : "auto" == this.options.pos && window.innerHeight - u - e.outerHeight() + $body.scrollTop() < 0 && l >= 0 && (r.top = l, e.addClass("uk-dropdown-up")), r.minWidth = e.actual("outerWidth"), e.css(r).addClass("uk-dropdown-active uk-dropdown-shown"), this.trigger("show.uk.datepicker"), i = this
        },
        add: function(t, e) {
        ...
        update: function() {
            var t = this.getRows(this.current.year(), this.current.month()),
                i = this.options.template(t, this.options);
            e.html(i), this.trigger("update.uk.datepicker")
        },
        getRows: function(t, e) {
            var i = this.options,
                n = moment().format("YYYY-MM-DD"),
                o = [31, t % 4 === 0 && t % 100 !== 0 || t % 400 === 0 ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e],
            ...
            a.weekdays = function() {
                for (var t = 0, e = []; 7 > t; t++) {
                    for (var n = t + (i.weekstart || 0); n >= 7;) n -= 7;
                    e.push(i.i18n.weekdays[n])
                }
                return e
            }(), i.weekstart && i.weekstart > 0 && (s -= i.weekstart, 0 > s && (s += 7));
            for (var l = o + s, u = l; u > 7;) u -= 7;
            l += 7 - u;
            for (var d, c, h, p, f, m = 0, g = 0; l > m; m++) d = new Date(t, e, 1 + (m - s)), c = i.mindate && d < i.mindate || i.maxdate && d > i.maxdate, f = !(s > m || m >= o + s), d = moment(d), h = this.initdate == d.format("YYYY-MM-DD"), p = n == d.format("YYYY-MM-DD"), r.push({
                selected: h,
                today: p,
                disabled: c,
                day: d,
        ...
        hide: function() {
            i && i === this && (e.removeClass("uk-dropdown-shown"), setTimeout(function() {
                e.removeClass("uk-dropdown-active uk-dropdown-up")
    ...
    return t.component("formPassword", {
        ...
        boot: function() {
            t.$html.on("click.formpassword.uikit", "[data-uk-form-password]", function(e) {
                var i = t.$(this);
                if (!i.data("formPassword")) {
                    e.preventDefault(); {
                        t.formPassword(i, t.Utils.options(i.attr("data-uk-form-password")))
                    }
                    i.trigger("click")
                }
            })
    ...
    t.component("grid", {
        ...
        boot: function() {
            t.ready(function(e) {
                t.$("[data-uk-grid]", e).each(function() {
                    var e = t.$(this);
                    if (!e.data("grid")) {
                        t.grid(e, t.Utils.options(e.attr("data-uk-grid")))
                    }
                })
            })
        },
        init: function() {
            var e = this,
                i = String(this.options.gutter).trim().split(" ");
            this.gutterv = parseInt(i[0], 10), this.gutterh = parseInt(i[1] || i[0], 10), this.element.css({
                position: "relative"
            }), this.controls = null, this.options.controls && (this.controls = t.$(this.options.controls), this.controls.on("click", "[data-uk-filter]", function(i) {
        ...
        updateLayout: function(i) {
            ...
            var n, o, s, a, r, l, u, d, c = i,
                h = this.element.width() + 2 * this.gutterh + 2,
                p = 0,
                f = 0,
                m = [];
            this.trigger("beforeupdate.uk.grid", [c]), c.each(function(i) {
                for (d = e(this), n = t.$(this), o = d.outerWidth, s = d.outerHeight, p = 0, f = 0, r = 0, u = m.length; u > r; r++) a = m[r], p <= a.aX && (p = a.aX), p + o > h && (p = 0), f <= a.aY && (f = a.aY);
                m.push({
                    ele: n,
                    top: f,
                    left: p,
        ...
        filter: function(e) {
            this.currentfilter = e, e = e || [], "string" == typeof e && (e = e.split(/,/).map(function(t) {
                return t.trim()
            }));
            var i = this,
            ...
            n.each(function(i) {
                ...
                s && (s = s.split(/,/).map(function(t) {
                    ...
                    s.indexOf(t) > -1 && (a = !0)
                })), o[a ? "visible" : "hidden"].push(n)
            }), o.hidden = t.$(o.hidden).map(function() {
                return this[0]
            }), o.visible = t.$(o.visible).map(function() {
                return this[0]
            }), o.hidden.attr("aria-hidden", "true").filter(":visible").fadeOut(this.options.duration), o.visible.attr("aria-hidden", "false").filter(":hidden").css("opacity", 0).show(), i.updateLayout(o.visible), this.controls && this.controls.length && this.controls.find("[data-uk-filter]").removeClass("uk-active").filter('[data-uk-filter="' + e + '"]').addClass("uk-active")
        },
        sort: function(e, i) {
            i = i || 1, "string" == typeof i && (i = "desc" == i.toLowerCase() ? -1 : 1);
            var n = this.element.children();
            n.sort(function(n, o) {
                return n = t.$(n), o = t.$(o), (o.data(e) || "") < (n.data(e) || "") ? i : -1 * i
            }).appendTo(this.element), this.updateLayout(n.filter(":visible")), this.controls && this.controls.length && this.controls.find("[data-uk-sort]").removeClass("uk-active").filter('[data-uk-sort="' + e + ":" + (-1 == i ? "desc" : "asc") + '"]').addClass("uk-active")
        }
    });
    var i = function() {
            function t(t) {
                if (t) {
                    ...
                    for (var e, i = 0, n = u.length; n > i; i++) if (e = u[i] + t, "string" == typeof d[e]) return e
                }
            }
            function e(t) {
                var e = parseFloat(t),
            ...
            function o() {
                if (!p) {
                    ...
                    if (a = function() {
                        ...
                        n.style.width = "200px", n.style.padding = "1px 2px 3px 4px", n.style.borderStyle = "solid", n.style.borderWidth = "1px 2px 3px 4px", n.style[r] = "border-box";
                        var o = document.body || document.documentElement;
                        o.appendChild(n);
                        var s = a(n);
                        l = 200 === e(s.width), o.removeChild(n)
                    }
                }
            }
            function s(t) {
                if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var u = s.isBorderBox = !(!r || !i[r] || "border-box" !== i[r]), d = 0, c = h.length; c > d; d++) {
                        var p = h[d],
                            f = i[p],
                            m = parseFloat(f);
                        s[p] = isNaN(m) ? 0 : m
            ...
            var a, r, l, u = "Webkit Moz ms Ms O".split(" "),
                d = document.documentElement.style,
                c = "undefined" == typeof console ? i : function(t) {
                    console.error(t)
                },
    ...
    return t.component("nestable", {
        ...
        boot: function() {
            t.$html.on("mousemove touchmove", function(i) {
                if (e) {
                    var n = e.offset().top;
                    n < t.$win.scrollTop() ? t.$win.scrollTop(t.$win.scrollTop() - Math.ceil(e.height() / 2)) : n + e.height() > window.innerHeight + t.$win.scrollTop() && t.$win.scrollTop(t.$win.scrollTop() + Math.ceil(e.height() / 2))
                }
            }), t.ready(function(e) {
            ...
            Object.keys(this.options).forEach(function(t) {
                ...
                if (!n.dragEl && (i || 0 === e.button)) {
                    ...
                    var o = t.$(e.currentTarget),
                        s = o.data("nestableAction"),
                        a = o.closest(n.options._listItemClass);
                    "collapse" === s && n.collapseItem(a), "expand" === s && n.expandItem(a), "toggle" === s && n.toggleItem(a)
                }
            });
            var o = function(e) {
                    var o = t.$(e.target);
                    e.target !== n.element[0] && (o.is(n.options._noDragClass) || o.closest(n.options._noDragClass).length || o.is("[data-nestable-action]") || o.closest("[data-nestable-action]").length || (n.options.handleClass && !o.hasClass(n.options.handleClass) && n.options.handleClass && (o = o.closest(n.options._handleClass)), !o.length || n.dragEl || !i && 0 !== e.button || i && 1 !== e.touches.length || (e.originalEvent && e.originalEvent.touches && (e = evt.originalEvent.touches[0]), n.delayMove = function(t) {
                        t.preventDefault(), n.dragStart(e), n.trigger("start.uk.nestable", [n]), n.delayMove = !1
                    }, n.delayMove.x = parseInt(e.pageX, 10), n.delayMove.y = parseInt(e.pageY, 10), n.delayMove.threshold = n.options.idlethreshold, e.preventDefault())))
                },
                d = function(t) {
                ...
                c = function(t) {
                    n.dragEl && (t.preventDefault(), n.dragStop(i ? t.touches[0] : t)), e = !1, n.delayMove = !1
                };
            i ? (this.element[0].addEventListener(a, o, !1), window.addEventListener(r, d, !1), window.addEventListener(l, c, !1), window.addEventListener(u, c, !1)) : (this.on(a, o), s.on(r, d), s.on(l, c))
        },
        serialize: function() {
            var e, i = 0,
                n = this,
                o = function(e, i) {
                    var s = [],
                        a = e.children(n.options._listItemClass);
                    return a.each(function() {
                        for (var e, a = t.$(this), r = {}, l = a.children(n.options._listClass), u = 0; u < a[0].attributes.length; u++) e = a[0].attributes[u], 0 === e.name.indexOf("data-") && (r[e.name.substr(5)] = t.Utils.str2json(e.value));
                        l.length && (r.children = o(l, i + 1)), s.push(r)
                    }), s
                };
            return e = o(n.element, i)
        },
        list: function(e) {
            var i = [],
                n = this,
                o = 0,
                s = function(n, o, a) {
                    var r = n.children(e._listItemClass);
                    r.each(function(n) {
                        var r = t.$(this),
                            l = t.$.extend({
                                parent_id: a ? a : null,
                            ...
                            u = r.children(e._listClass);
                        i.push(l), u.length && s(u, o + 1, r.data(e.idProperty || "id"))
                    })
                };
            return e = t.$.extend({}, n.options, e), s(n.element, o), i
        },
        reset: function() {
            this.mouse = {
                offsetX: 0,
            ...
            for (var t = 0; t < o.length; t++) this.checkEmptyList(o[t]);
            o = []
        },
        ...
        dragStart: function(i) {
            var o = this.mouse,
                s = t.$(i.target),
                a = s.closest(this.options._listItemClass),
                r = a.offset();
            ...
            var l, u, d = this.dragEl.find(this.options._listItemClass);
            for (l = 0; l < d.length; l++) u = t.$(d[l]).parents(this.options._listClass + "," + this.options._listBaseClass).length, u > this.dragDepth && (this.dragDepth = u);
            n.addClass(this.options.movingClass)
        },
        dragStop: function(t) {
            var e = this.placeEl,
                i = this.placeEl.parents(this.options._listBaseClass + ":first");
            this.placeEl.removeClass(this.options.placeholderClass), this.dragEl.remove(), this.element[0] !== i[0] ? (i.trigger("change.uk.nestable", [e, "added", i, i.data("nestable")]), this.element.trigger("change.uk.nestable", [e, "removed", this.element, this])) : this.element.trigger("change.uk.nestable", [e, "moved", this.element, this]), this.trigger("stop.uk.nestable", [this, e]), this.reset(), n.removeClass(this.options.movingClass)
        },
        dragMove: function(e) {
            var i, n, s, a, r, l = this.options,
                u = this.mouse,
                d = this.dragRootEl ? this.dragRootEl.data("nestable").options.maxDepth : l.maxDepth;
            this.dragEl.css({
                left: e.pageX - u.offsetX,
                top: e.pageY - u.offsetY
            }), u.lastX = u.nowX, u.lastY = u.nowY, u.nowX = e.pageX, u.nowY = e.pageY, u.distX = u.nowX - u.lastX, u.distY = u.nowY - u.lastY, u.lastDirX = u.dirX, u.lastDirY = u.dirY, u.dirX = 0 === u.distX ? 0 : u.distX > 0 ? 1 : -1, u.dirY = 0 === u.distY ? 0 : u.distY > 0 ? 1 : -1;
            var c = Math.abs(u.distX) > Math.abs(u.distY) ? 1 : 0;
            if (!u.moving) return u.dirAx = c, void(u.moving = !0);
            u.dirAx !== c ? (u.distAxX = 0, u.distAxY = 0) : (u.distAxX += Math.abs(u.distX), 0 !== u.dirX && u.dirX !== u.lastDirX && (u.distAxX = 0), u.distAxY += Math.abs(u.distY), 0 !== u.dirY && u.dirY !== u.lastDirY && (u.distAxY = 0)), u.dirAx = c, u.dirAx && u.distAxX >= l.threshold && (u.distAxX = 0, s = this.placeEl.prev("li"), u.distX > 0 && s.length && !s.hasClass(l.collapsedClass) && (i = s.find(l._listClass).last(), r = this.placeEl.parents(l._listClass + "," + l._listBaseClass).length, r + this.dragDepth <= d && (i.length ? (i = s.children(l._listClass).last(), i.append(this.placeEl)) : (i = t.$("<ul/>").addClass(l.listClass), i.append(this.placeEl), s.append(i), this.setParent(s)))), u.distX < 0 && (a = this.placeEl.next("li"), a.length || (n = this.placeEl.parent(), this.placeEl.closest(l._listItemClass).after(this.placeEl), n.children().length || this.unsetParent(n.parent()))));
            var h = !1,
                p = this.dragEl.offset().left - (window.pageXOffset || document.scrollLeft || 0),
                f = e.pageY - (window.pageYOffset || document.documentElement.scrollTop);
            if (this.pointEl = t.$(document.elementFromPoint(p, f)), l.handleClass && this.pointEl.hasClass(l.handleClass)) this.pointEl = this.pointEl.closest(l._listItemClass);
            else {
                var m = this.pointEl.closest(l._listItemClass);
                m.length && (this.pointEl = m)
            }
            if (!this.placeEl.find(this.pointEl).length) {
                ...
                else if (!this.pointEl.length || !this.pointEl.hasClass(l.listItemClass)) return;
                var g = this.element,
                    v = this.pointEl.closest(this.options._listBaseClass),
                    k = g[0] !== this.pointEl.closest(this.options._listBaseClass)[0];
                if (!u.dirAx || k || h) {
                    if (k && l.group !== v.data("nestable-group")) return;
                    if (o.push(g), r = this.dragDepth - 1 + this.pointEl.parents(l._listClass + "," + l._listBaseClass).length, r > d) return;
                    var w = e.pageY < this.pointEl.offset().top + this.pointEl.height() / 2;
                    n = this.placeEl.parent(), h ? this.pointEl.append(this.placeEl) : w ? this.pointEl.before(this.placeEl) : this.pointEl.after(this.placeEl), n.children().length || n.data("nestable") || this.unsetParent(n.parent()), this.checkEmptyList(this.dragRootEl), this.checkEmptyList(g), k && (this.dragRootEl = v, this.hasNewRoot = this.element[0] !== this.dragRootEl[0])
                }
            }
        },
        checkEmptyList: function(e) {
            e = e ? t.$(e) : this.element, e.children().length || e.html("")
        }
    }), t.nestable
}), function(t) {
    var e;
    ...
    return t.$.extend(s.prototype, {
        ...
        close: function(t) {
            var n = this,
                o = function() {
                    n.element.remove(), e[n.options.pos].children().length || e[n.options.pos].hide(), n.options.onClose.apply(n, []), n.element.trigger("close.uk.notify", [n]), delete i[n.uuid]
                };
        ...
        pos: "top-center",
        onClose: function() {}
    }, t.notify = n, t.notify.message = s, t.notify.closeAll = o, n
}), function(t) {
    var e;
    ...
    var s, a, r, l, u, d, c, h, p, f = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch;
    return t.component("sortable", {
        ...
        boot: function() {
            t.ready(function(e) {
                ...
                if (c) {
                    ...
                    (Math.abs(i.pageX - c.pos.x) > c.threshold || Math.abs(i.pageY - c.pos.y) > c.threshold) && c.apply(i)
                }
                if (s) {
                    u || (u = !0, s.show(), s.$current.addClass(s.$sortable.options.placeholderClass), s.$sortable.element.children().addClass(s.$sortable.options.childClass), t.$html.addClass(s.$sortable.options.dragMovingClass));
                    var n = s.data("mouse-offset"),
                        o = parseInt(e.originalEvent.pageX, 10) + n.left,
                        a = parseInt(e.originalEvent.pageY, 10) + n.top;
                    s.css({
                        left: o,
                        top: a
                    }), a < t.$win.scrollTop() ? t.$win.scrollTop(t.$win.scrollTop() - Math.ceil(s.height() / 2)) : a + s.height() > window.innerHeight + t.$win.scrollTop() && t.$win.scrollTop(t.$win.scrollTop() + Math.ceil(s.height() / 2))
                }
            }), t.$html.on("mouseup touchend", function(t) {
                if (c = d = !1, !a || !s) return void(a = s = null);
                var i = e(t.target),
                    n = s.$sortable,
                    o = {
                        type: t.type
                    };
                i[0] && n.dragDrop(o, n.element), n.dragEnd(o, n.element)
            })
        },
        init: function() {
            function e() {
                f ? d.addEventListener("touchmove", v, !1) : (d.addEventListener("mouseover", m, !1), d.addEventListener("mouseout", g, !1))
            }
            function i() {
                f ? d.removeEventListener("touchmove", v, !1) : (d.removeEventListener("mouseover", m, !1), d.removeEventListener("mouseout", g, !1))
            }
            function s(t) {
                a && u.dragMove(t, u)
            }
            function l(e) {
                return function(i) {
                    var o, s, a;
                    i && (o = f && i.touches && i.touches[0] || {}, s = o.target || i.target, f && document.elementFromPoint && (s = document.elementFromPoint(i.pageX - document.body.scrollLeft, i.pageY - document.body.scrollTop))), t.$(s).hasClass(u.options.childClass) ? e.apply(s, [i]) : s !== d && (a = n(d, s), a && e.apply(a, [i]))
                }
            }
            var u = this,
                d = this.element[0];
            h = [], 0 === this.element.children().length && this.element.html(""), this.element.data("sortable-group", this.options.group ? this.options.group : t.Utils.uid("sortable-group"));
            var c = l(function(e) {
                var i = t.$(e.target),
                    n = i.is("a[href]") ? i : i.parents("a[href]");
                if (!i.is(":input")) return e.preventDefault(), !f && n.length && n.one("click", function(t) {
                    t.preventDefault()
                ...
                m = (l(function(t) {
                    ...
                    return u.dragEnter(t, this)
                }), 40)),
                g = l(function(e) {
                    var i = u.dragenterData(this);
                    u.dragenterData(this, i - 1), u.dragenterData(this) || (t.$(this).removeClass(u.options.overClass), u.dragenterData(this, !1))
                }),
                v = l(function(t) {
                    return a && a !== this && r !== this ? (u.element.children().removeClass(u.options.overClass), r = this, u.moveElementNextTo(a, this), o(t)) : !0
                });
            this.addDragHandlers = e, this.removeDragHandlers = i, window.addEventListener(f ? "touchmove" : "mousemove", s, !1), d.addEventListener(f ? "touchstart" : "mousedown", c, !1)
        },
        dragStart: function(e, i) {
            ...
            if (f || 2 != e.button) {
                if (n.options.handleClass) {
                    var r = o.hasClass(n.options.handleClass) ? o : o.closest("." + n.options.handleClass, n.element);
                    if (!r.length) return
                }
                if (!o.is("." + n.options.noDragClass) && !o.closest("." + n.options._noDragClass).length && !o.is(":input")) {
                    a = i, s && s.remove();
                    var d = t.$(a),
                        h = d.offset();
                    c = {
                        ...
                        threshold: n.options.threshold,
                        apply: function(e) {
                            s = t.$('<div class="' + [n.options.draggingClass, n.options.dragCustomClass].join(" ") + '"></div>').css({
                                display: "none",
                                top: h.top,
                                left: h.left,
                                width: d.width(),
                                height: d.height(),
                                padding: d.css("padding")
                            }).data({
                                "mouse-offset": {
                                ...
                                origin: n.element,
                                index: d.index()
                            }).append(d.html()).appendTo("body"), s.$current = d, s.$sortable = n, d.data("sortable-group", n.options.group), n.addDragHandlers(), n.options.start(this, a), n.trigger("start.uk.sortable", [n, a]), p = !0, c = !1
                        }
                    }
                }
            }
        ...
        dragMove: function(e, i) {
            var n, o = t.$(document.elementFromPoint(e.pageX - document.body.scrollLeft, e.pageY - (window.pageYOffset || document.documentElement.scrollTop))),
                s = o.closest("." + this.options.baseClass),
                r = s.data("sortable-group"),
                l = t.$(a),
                u = l.parent(),
                d = l.data("sortable-group");
            s[0] !== u[0] && void 0 !== d && r === d && (s.data("sortable").addDragHandlers(), h.push(s), s.children().addClass(this.options.childClass), s.children().length > 0 ? (n = o.closest("." + this.options.childClass), n.before(l)) : o.append(l), 0 === u.children().length && u.html(""), UIkit.$doc.trigger("mouseover"))
        },
        dragEnter: function(e, i) {
            if (!a || a === i) return !0;
            var n = this.dragenterData(i);
            return this.dragenterData(i, n + 1), 0 === n && (t.$(i).addClass(this.options.overClass), this.moveElementNextTo(a, i)), !1
        },
        dragEnd: function(e, i) {
            var n = this;
            a && (this.options.stop(i), this.trigger("stop.uk.sortable", [this])), a = null, r = null, h.push(this.element), h.forEach(function(e, i) {
            ...
            }), h = [], t.$html.removeClass(this.options.dragMovingClass), this.removeDragHandlers(), s && (s.remove(), s = null)
        },
        ...
        triggerChangeEvents: function() {
            if (a) {
                var e = t.$(a),
                    i = s.data("origin"),
                    n = e.closest("." + this.options.baseClass),
                    o = [];
                i[0] === n[0] && s.data("index") != e.index() ? o.push({
                    el: this,
                    mode: "moved"
                }) : i[0] != n[0] && o.push({
                    el: n,
                    ...
                    t.el.trigger("change.uk.sortable", [t.el, a, t.mode])
                })
            }
        },
        ...
        moveElementNextTo: function(e, n) {
            ...
            var o = this,
                ...
                a = i(e, n) ? n : n.nextSibling,
                r = s.children(),
                u = r.length;
            return o.options.animation ? (s.css("min-height", s.height()), r.stop().each(function() {
                var e = t.$(this),
                    i = e.position();
                i.width = e.width(), e.data("offset-before", i)
            }), n.parentNode.insertBefore(e, a), t.Utils.checkDisplay(o.element.parent()), r = s.children().each(function() {
                var e = t.$(this);
                e.data("offset-after", e.position())
            }).each(function() {
                var e = t.$(this),
                    i = e.data("offset-before");
                e.css({
                    position: "absolute",
                    top: i.top,
                    left: i.left,
                ...
                var e = t.$(this),
                    i = (e.data("offset-before"), e.data("offset-after"));
                e.css("pointer-events", "none").width(), setTimeout(function() {
                    e.animate({
                        top: i.top,
                        left: i.left
                    }, o.options.animation, function() {
                        e.css({
                            position: "",
                            top: "",
                            left: "",
                            "min-width": "",
                            "pointer-events": ""
                        }).removeClass(o.options.overClass).removeData("child-dragenter"), u--, u || (s.css("min-height", ""), t.Utils.checkDisplay(o.element.parent()))
                    })
                }, 0)
            })) : (n.parentNode.insertBefore(e, a), void t.Utils.checkDisplay(o.element.parent()))
        },
        serialize: function() {
            var e, i, n = [];
            return this.element.children().each(function(o, s) {
                e = {};
    ...
    function e() {
        var e = arguments.length ? arguments : o;
        if (e.length && !(i.scrollTop() < 0)) for (var s, a, r, l, u = i.scrollTop(), d = n.height(), c = i.height(), h = d - c, p = u > h ? h - u : 0, f = 0; f < e.length; f++) if (l = e[f], l.element.is(":visible") && !l.animate) {
            if (l.check()) {
                if (l.options.top < 0 ? s = 0 : (r = l.element.outerHeight(), s = d - r - l.options.top - l.options.bottom - u - p, s = 0 > s ? s + l.options.top : l.options.top), l.boundary && l.boundary.length) {
                    var m = l.boundary.position().top;
                    a = l.boundtoparent ? d - (m + l.boundary.outerHeight()) + parseInt(l.boundary.css("padding-bottom")) : d - m - parseInt(l.boundary.css("margin-top")), s = u + r > d - a - (l.options.top < 0 ? 0 : l.options.top) ? d - a - (u + r) : s
                }
                if (l.currentTop != s) {
                    if (l.element.css({
                        position: "fixed",
                    ...
                    }), !l.init && (l.element.addClass(l.options.clsinit), location.hash && u > 0 && l.options.target)) {
                        var g = t.$(location.hash);
                        g.length && setTimeout(function(t, e) {
                            return function() {
                                e.element.width();
                                var i = t.offset(),
                                    n = i.top + t.outerHeight(),
                                    o = e.element.offset(),
                                    s = e.element.outerHeight(),
                                    a = o.top + s;
                                o.top < n && i.top < a && (u = i.top - s - e.options.target, window.scrollTo(0, u))
                            }
                        }(g, l), 0)
                    }
                    l.element.addClass(l.options.clsactive), l.element.css("margin", ""), l.options.animation && l.init && l.element.addClass(l.options.animation), l.currentTop = s
                }
    ...
    return t.component("sticky", {
        ...
        boot: function() {
            t.$doc.on("scrolling.uk.document", function() {
                e()
            }), t.$win.on("resize orientationchange", t.Utils.debounce(function() {
                if (o.length) {
        ...
        init: function() {
            var e, s = t.$('<div class="uk-sticky-placeholder"></div>'),
                a = this.options.boundary;
            this.wrapper = this.element.css("margin", 0).wrap(s).parent(), this.computeWrapper(), a && (a === !0 ? (a = this.wrapper.parent(), e = !0) : "string" == typeof a && (a = t.$(a))), this.sticky = {
                self: this,
                ...
                reset: function(e) {
                    ...
                    !e && this.options.animation && t.support.animation ? (this.animate = !0, this.element.removeClass(this.options.animation).one(t.support.animation.end, function() {
                        i()
                ...
                check: function() {
                    ...
                    var t = i.scrollTop(),
                        ...
                        s = t > o ? o - t : 0,
                        a = this.wrapper.offset().top,
                        r = a - this.options.top - s;
                    return t >= r
                }
            }, o.push(this.sticky)
        },
    ...
    return t.component("tooltip", {
        defaults: {
            ...
            activeClass: "uk-active",
            src: function(t, e) {
                return e = t.attr("title"), e && t.data("cached-title", e).removeAttr("title"), t.data("cached-title")
            }
        },
        tip: "",
        boot: function() {
            t.$html.on("mouseenter.tooltip.uikit focus.tooltip.uikit", "[data-uk-tooltip]", function(e) {
                ...
                if (!i.data("tooltip")) {
                    {
                        t.tooltip(i, t.Utils.options(i.attr("data-uk-tooltip")))
                    }
        ...
        show: function() {
            if (this.tip = "function" == typeof this.options.src ? this.options.src(this.element) : this.options.src, i && clearTimeout(i), n && clearTimeout(n), this.tip.length) {
                e.stop().css({
                    top: -2e3,
                    visibility: "hidden"
                ...
                var o = this,
                    ...
                    u = "function" == typeof this.options.pos ? this.options.pos.call(this.element) : this.options.pos,
                    d = u.split("-"),
                    c = {
                        display: "none",
                        visibility: "visible",
                ...
                t.$.extend(c, m[d[0]]), 2 == d.length && (c.left = "left" == d[1] ? s.left : s.left + s.width - a);
                var g = this.checkBoundary(c.left, c.top, a, r);
                if (g) {
                    switch (g) {
                    case "x":
                        u = 2 == d.length ? d[0] + "-" + (c.left < 0 ? "left" : "right") : c.left < 0 ? "right" : "left";
                        break;
                    case "y":
                        u = 2 == d.length ? (c.top < 0 ? "bottom" : "top") + "-" + d[1] : c.top < 0 ? "bottom" : "top";
                        break;
                    case "xy":
                        u = 2 == d.length ? (c.top < 0 ? "bottom" : "top") + "-" + (c.left < 0 ? "left" : "right") : c.left < 0 ? "right" : "left"
                    }
                    d = u.split("-"), t.$.extend(c, m[d[0]]), 2 == d.length && (c.left = "left" == d[1] ? s.left : s.left + s.width - a)
                }
                c.left -= t.$body.position().left, i = setTimeout(function() {
                    e.css(c).attr("class", ["uk-tooltip", "uk-tooltip-" + u, o.options.cls].join(" ")), o.options.animation ? e.css({
                        opacity: 0,
                        display: "block"
                    }).addClass(o.options.activeClass).animate({
                        opacity: 1
                    }, parseInt(o.options.animation, 10) || 400) : e.show().addClass(o.options.activeClass), i = !1, n = setInterval(function() {
        ...
        hide: function() {
            if (!this.element.is("input") || this.element[0] !== document.activeElement) if (i && clearTimeout(i), n && clearTimeout(n), e.stop(), this.options.animation) {
                var t = this;
    ...
    var e;
    window.UIkit && (e = t(UIkit)), "function" == typeof define && define.amd && define("uikit-search", ["uikit"], function() {
        return e || t(UIkit)
    })
}(function(t) {
    "use strict";
    ...
    function e(t, e) {
        ...
        for (i = t, n = ""; e > i; i++) n = "" + i, 10 > i && (n = "0" + n), o["24h"].push({
            value: n + ":00"
        }), o["24h"].push({
            value: n + ":30"
        }), 0 === i && (n = 12, o["12h"].push({
            ...
            value: n + ":30 AM"
        })), i > 0 && 13 > i && 12 !== i && (o["12h"].push({
            value: n + ":00 AM"
        }), o["12h"].push({
            value: n + ":30 AM"
        })), i >= 12 && (n -= 12, 0 === n && (n = 12), 10 > n && (n = "0" + String(n)), o["12h"].push({
            value: n + ":00 PM"
        }), o["12h"].push({
            value: n + ":30 PM"
        }));
    ...
    t.component("timepicker", {
        ...
        boot: function() {
            t.$html.on("focus.timepicker.uikit", "[data-uk-timepicker]", function(e) {
                ...
                if (!i.data("timepicker")) {
                    var n = t.timepicker(i, t.Utils.options(i.attr("data-uk-timepicker")));
                    setTimeout(function() {
                        n.autocomplete.input.focus()
                    }, 40)
                }
            })
        },
        init: function() {
            var i, n = this,
                o = e(this.options.start, this.options.end);
            this.options.minLength = 0, this.options.template = '<ul class="uk-nav uk-nav-autocomplete uk-autocomplete-results">{{~items}}<li data-value="{{$item.value}}"><a class="needsclick">{{$item.value}}</a></li>{{/items}}</ul>', this.options.source = function(t) {
                ...
                var t = n.autocomplete.dropdown.find('[data-value="' + n.autocomplete.input.val() + '"]');
                setTimeout(function() {
                    n.autocomplete.pick(t, !0)
                }, 10)
            }), this.autocomplete.input.on("focus", function() {
                n.autocomplete.value = Math.random(), n.autocomplete.triggercomplete()
    ...
    function e(n, o) {
        function s(e, i) {
            ...
            if (i.before(i, e) !== !1) {
                for (var s, a = 0; s = e[a]; a++) n.append(i.param, s);
                ...
                }, i.beforeSend(o), o.send(n)
            }
        }
        if (!t.support.ajaxupload) return this;
        if (o = t.$.extend({}, e.defaults, o), n.length) {
            if ("*.*" !== o.allow) for (var a, r = 0; a = n[r]; r++) if (!i(o.allow, a.name)) return void("string" == typeof o.notallowed ? alert(o.notallowed) : o.notallowed(a, o));
            var l = o.complete;
            if (o.single) {
                var u = n.length,
                    d = 0,
                    c = !0;
                o.beforeAll(n), o.complete = function(t, e) {
                    d += 1, l(t, e), o.filelimit && d >= o.filelimit && (c = !1), c && u > d ? s([n[d]], o) : o.allcomplete(t, e)
                }, s([n[0]], o)
            } else o.complete = function(t, e) {
                l(t, e), o.allcomplete(t, e)
            }, s(n, o)
        }
    }
    function i(t, e) {
